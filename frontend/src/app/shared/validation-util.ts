...
export class ValidationUtil {
    private static KEYS = {
        required: 'global.messages.required-field',
        notSame: 'global.messages.not-same',
        '_default': 'global.messages.invalid-field'
    };
    ...
    public static getErrorMessages( control: AbstractControl): string {
        ...
        keys = keys.length > 0 ? keys : [' ']; // avoids missing key exception on empty array
